...
//go:embed plugins/go-ent/schemas/*.json
...
//go:embed plugins/go-ent/commands/aliases/*.md
//go:embed plugins/go-ent/commands/context/*.md
//go:embed plugins/go-ent/commands/utilities/*.md
//go:embed plugins/go-ent/commands/workflows/*.md
