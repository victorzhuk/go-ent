...
func newSkillCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "skill",
		Short: "Manage skills",
		Long:  "List and inspect available skills and their capabilities",
	}
...
func printSkillInfo(meta *skill.SkillMeta) error {
	...
	// Read and display full content from file
	content, err := os.ReadFile(meta.FilePath)
	if err == nil {
		// Skip frontmatter and show markdown content
...
func extractShortDescription(desc string) string {
	// Extract text before "Auto-activates for:"
