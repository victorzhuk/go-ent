...
Core domain types for the multi-agent orchestration system. These types establish the vocabulary and contracts used throughout the agent selection, execution, and skill management subsystems.
