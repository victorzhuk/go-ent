...
allowed-tools: Read, Bash, Edit, mcp__plugin_serena_serena, mcp__goent__goent_workflow_start, mcp__goent__goent_workflow_status
---
...
1. **Start workflow**: `goent_workflow_start` with change_id and phase="discovery"
...
6. Run `/goent:research <change-id>`
...
/goent:plan "Add two-factor authentication with OTP"

# Phase 0
→ Creates proposal, gets change-id: add-2fa
→ Runs /goent:clarify add-2fa
→ Asks 5 questions
← User answers questions
→ Runs /goent:research add-2fa
...
# Phase 2
→ Runs /goent:decompose add-2fa
→ Generates tasks with IDs T001-T015
→ Runs /goent:analyze add-2fa
→ Checks coverage: 100%
